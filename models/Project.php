...
class Project extends \yii\db\ActiveRecord
{
    ...
    public function afterSave($insert, $changedAttributes)
    {
        ...
        if (is_array($this->users_array)) {
            $arr = ArrayHelper::map($this->users, 'user_id', 'user_id');
            ...
            WorkingOn::deleteAll(['user_id' => $arr]);
        } else {
            WorkingOn::deleteAll(['project_id' => $this->project_id]);
        }
    }
}
